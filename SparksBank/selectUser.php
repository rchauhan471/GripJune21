...
<body>
	...
	<section>
		<div class="wrapper">
			...
			<div class="center">
				<button type="submit" class="waves-effect waves-light btn z-depth-2" style="background-color: #39a6a3; margin: 20px; radius: 10px; ">Submit</button>
				<a href="index.php" class="waves-effect waves-light btn z-depth-2" style="background-color: #bf1363; margin: 20px;">Home</a> 
			</div>
